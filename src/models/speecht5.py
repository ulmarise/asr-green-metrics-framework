...
import torch
from transformers import SpeechT5Processor, SpeechT5ForSpeechToText, pipeline
import librosa
import os
import sys
import argparse
...
def main():
    parser = argparse.ArgumentParser(description="Run SpeechT5 ASR model on audio files")
    ...
    try:
        ...
        model = SpeechT5ForSpeechToText.from_pretrained(args.model_id)
