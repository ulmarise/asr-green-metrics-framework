...
import torch
from transformers import AutoProcessor, HubertForCTC, pipeline
import librosa
import os
import sys
import argparse
...
def main():
    parser = argparse.ArgumentParser(description="Run HuBERT ASR model on audio files")
    ...
    try:
        ...
        model = HubertForCTC.from_pretrained(args.model_id, low_cpu_mem_usage=True)
